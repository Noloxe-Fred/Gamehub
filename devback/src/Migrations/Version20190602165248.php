 ...
 */
final class Version20190602165248 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE state (id INT AUTO_INCREMENT NOT NULL, game_id INT DEFAULT NULL, user_id INT DEFAULT NULL, status ENUM(\'have\', \'want\', \'would_like\'), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_A393D2FBE48FD905 (game_id), INDEX IDX_A393D2FBA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
