 ...
 */
final class Version20190610095607 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE Comment (id INT AUTO_INCREMENT NOT NULL, game_id INT DEFAULT NULL, user_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, is_active TINYINT(1) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_5BC96BF0E48FD905 (game_id), INDEX IDX_5BC96BF0A76ED395 (user_id), UNIQUE INDEX UNIQ_5BC96BF0A76ED395E48FD905 (user_id, game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE game (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, score SMALLINT UNSIGNED DEFAULT NULL, cover VARCHAR(255) DEFAULT NULL, illustration VARCHAR(255) DEFAULT NULL, pegi SMALLINT UNSIGNED DEFAULT NULL, website VARCHAR(255) DEFAULT NULL, released_at DATE DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE Score (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, game_id INT DEFAULT NULL, value SMALLINT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_F3581855A76ED395 (user_id), INDEX IDX_F3581855E48FD905 (game_id), UNIQUE INDEX UNIQ_F3581855A76ED395E48FD905 (user_id, game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE State (id INT AUTO_INCREMENT NOT NULL, game_id INT DEFAULT NULL, user_id INT DEFAULT NULL, status ENUM(\'have\', \'want\', \'waiting\'), created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_6252FDFFE48FD905 (game_id), INDEX IDX_6252FDFFA76ED395 (user_id), UNIQUE INDEX UNIQ_6252FDFFA76ED395E48FD905 (user_id, game_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, firstname VARCHAR(255) DEFAULT NULL, lastname VARCHAR(255) DEFAULT NULL, pseudo VARCHAR(255) NOT NULL, photo VARCHAR(255) DEFAULT NULL, birthdate DATE DEFAULT NULL, is_active TINYINT(1) NOT NULL, biography LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D64986CC499D (pseudo), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE category ADD CONSTRAINT FK_64C19C1C54C8C93 FOREIGN KEY (type_id) REFERENCES type (id)');
        $this->addSql('ALTER TABLE Comment ADD CONSTRAINT FK_5BC96BF0E48FD905 FOREIGN KEY (game_id) REFERENCES game (id)');
        ...
        $this->addSql('ALTER TABLE Score ADD CONSTRAINT FK_F3581855A76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE Score ADD CONSTRAINT FK_F3581855E48FD905 FOREIGN KEY (game_id) REFERENCES game (id)');
        $this->addSql('ALTER TABLE State ADD CONSTRAINT FK_6252FDFFE48FD905 FOREIGN KEY (game_id) REFERENCES game (id)');
        $this->addSql('ALTER TABLE State ADD CONSTRAINT FK_6252FDFFA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE Comment DROP FOREIGN KEY FK_5BC96BF0E48FD905');
        ...
        $this->addSql('ALTER TABLE Score DROP FOREIGN KEY FK_F3581855E48FD905');
        $this->addSql('ALTER TABLE State DROP FOREIGN KEY FK_6252FDFFE48FD905');
        ...
        $this->addSql('ALTER TABLE Score DROP FOREIGN KEY FK_F3581855A76ED395');
        $this->addSql('ALTER TABLE State DROP FOREIGN KEY FK_6252FDFFA76ED395');
