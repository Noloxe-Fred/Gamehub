 ...
 */
final class Version20190529125817 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE state CHANGE status status VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE comment_like CHANGE value value VARCHAR(255) NOT NULL');
    }
