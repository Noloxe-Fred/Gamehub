...
// Returns the private 'App\Repository\ScoreRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/ScoreRepository.php';

return $this->privates['App\\Repository\\ScoreRepository'] = new \App\Repository\ScoreRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
