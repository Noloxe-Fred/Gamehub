...
// Returns the private 'App\Repository\EditorRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/EditorRepository.php';

return $this->privates['App\\Repository\\EditorRepository'] = new \App\Repository\EditorRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
