...
// Returns the private 'App\Repository\DeveloperRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DeveloperRepository.php';

return $this->privates['App\\Repository\\DeveloperRepository'] = new \App\Repository\DeveloperRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
