...
// Returns the private 'App\Repository\PlatformRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/PlatformRepository.php';

return $this->privates['App\\Repository\\PlatformRepository'] = new \App\Repository\PlatformRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
