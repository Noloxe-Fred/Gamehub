...
// Returns the private 'App\Repository\CommentLikeRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/CommentLikeRepository.php';

return $this->privates['App\\Repository\\CommentLikeRepository'] = new \App\Repository\CommentLikeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
