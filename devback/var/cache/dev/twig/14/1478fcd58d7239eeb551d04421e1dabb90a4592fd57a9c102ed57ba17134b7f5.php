...
class __TwigTemplate_8effeef2f3174641728337122c29c74f956e46488de17ac8a87eea309f10bdce extends \Twig\Template
{
    private $source;
...
(isset($context["id"]) || array_key_exists("id", $context) ? $context["id"] : (function () { throw new RuntimeError('Variable "id" does not exist.', 272, $this->source); })())]);
    ...
    public function block_form_rows($context, array $blocks = [])
    {
        ...
        // line 402
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_array_filter((isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 402, $this->source); })()), function ($__child__) use ($context) { $context["child"] = $__child__; return  !twig_get_attribute($this->env, $this->source, $context["child"], "rendered", [], "any", false, false, false, 402); }));
        foreach ($context['_seq'] as $context["_key"] => $context["child"]) {
            // line 403
            echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock($context["child"], 'row');
        }
